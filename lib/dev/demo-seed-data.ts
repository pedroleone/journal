...
import type { MediaStatus, MediaType } from "../library";
...
const LIBRARY_ITEMS: Array<{
  ...
  { id: "library-book-1", type: "book", title: "The Left Hand of Darkness", creator: "Ursula K. Le Guin", url: null, status: "finished", rating: 5, reactions: ["thought-provoking", "beautiful"], genres: ["science fiction"], metadata: { pages: 304 }, content: "Finished this recently and kept thinking about the restraint in how it explains itself.", coverImageRef: "desk-book" },
  { id: "library-book-2", type: "book", title: "Bluets", creator: "Maggie Nelson", url: null, status: "in_progress", rating: null, reactions: ["intense"], genres: ["essay"], metadata: { pages: 96 }, content: "Reading this in small pieces works better than trying to rush it.", coverImageRef: "coffee-window" },
  { id: "library-book-3", type: "book", title: "A Psalm for the Wild-Built", creator: "Becky Chambers", url: null, status: "backlog", rating: null, reactions: ["cozy"], genres: ["science fiction"], metadata: { pages: 160 }, content: "Queued up for a low-stress weekend read.", coverImageRef: null },
  { id: "library-album-1", type: "album", title: "Vespertine", creator: "Björk", url: null, status: "finished", rating: 5, reactions: ["beautiful", "virtuoso"], genres: ["art pop"], metadata: { platform: ["vinyl"] }, content: "The production still feels meticulous without sounding cold.", coverImageRef: "vinyl-corner" },
  { id: "library-album-2", type: "album", title: "Promises", creator: "Floating Points / Pharoah Sanders", url: null, status: "in_progress", rating: null, reactions: ["beautiful"], genres: ["jazz", "ambient"], metadata: { platform: ["streaming"] }, content: "Using this as focus music for late afternoon work blocks.", coverImageRef: "shelf-detail" },
  { id: "library-album-3", type: "album", title: "Titanic Rising", creator: "Weyes Blood", url: null, status: "backlog", rating: null, reactions: ["interesting"], genres: ["indie pop"], metadata: { platform: ["streaming"] }, content: "I know I will like this; just have not made room for it yet.", coverImageRef: null },
  { id: "library-movie-1", type: "movie", title: "In the Mood for Love", creator: "Wong Kar-wai", url: null, status: "finished", rating: 5, reactions: ["beautiful", "thought-provoking"], genres: ["drama"], metadata: { runtime_minutes: 98 }, content: "Every frame is so controlled that even the pauses feel composed.", coverImageRef: "movie-theater" },
  { id: "library-movie-2", type: "movie", title: "Perfect Days", creator: "Wim Wenders", url: null, status: "finished", rating: 4, reactions: ["cozy"], genres: ["drama"], metadata: { runtime_minutes: 123 }, content: "Quiet in a way that makes everyday routines feel generous.", coverImageRef: "street-night" },
  { id: "library-movie-3", type: "movie", title: "Decision to Leave", creator: "Park Chan-wook", url: null, status: "dropped", rating: 3, reactions: ["interesting"], genres: ["thriller"], metadata: { runtime_minutes: 138 }, content: "Liked parts of it, but I was never in the right mood to finish.", coverImageRef: null },
  { id: "library-game-1", type: "game", title: "Balatro", creator: "LocalThunk", url: null, status: "in_progress", rating: null, reactions: ["funny", "intense"], genres: ["roguelike"], metadata: { platform: ["Switch"] }, content: "Great for fifteen-minute bursts that somehow turn into an hour.", coverImageRef: "game-handheld" },
  { id: "library-game-2", type: "game", title: "Citizen Sleeper", creator: "Jump Over the Age", url: null, status: "finished", rating: 5, reactions: ["thought-provoking"], genres: ["rpg"], metadata: { platform: ["PC"] }, content: "One of the few games lately that made me want to journal afterward.", coverImageRef: "desk-book" },
  { id: "library-game-3", type: "game", title: "Mini Motorways", creator: "Dinosaur Polo Club", url: null, status: "backlog", rating: null, reactions: ["cozy"], genres: ["strategy"], metadata: { platform: ["iPad"] }, content: "Saving this for low-friction evenings.", coverImageRef: null },
  { id: "library-video-1", type: "video", title: "Tokyo Morning Walks", creator: "A Bao", url: null, status: "finished", rating: 4, reactions: ["cozy"], genres: ["travel"], metadata: { platform: ["YouTube"] }, content: "Good background viewing while planning the day.", coverImageRef: "sunset-walk" },
  { id: "library-video-2", type: "video", title: "Designing Small Interfaces", creator: "Layout Craft", url: null, status: "in_progress", rating: null, reactions: ["interesting"], genres: ["design"], metadata: { platform: ["YouTube"] }, content: "Mostly watching this for spacing and hierarchy notes.", coverImageRef: "notebook-flatlay" },
  { id: "library-video-3", type: "video", title: "Street Food Diaries: Osaka", creator: "Field Notes", url: null, status: "backlog", rating: null, reactions: ["funny"], genres: ["food"], metadata: { platform: ["YouTube"] }, content: "Queued for a weekend lunch break.", coverImageRef: null },
  { id: "library-misc-1", type: "misc", title: "Ceramic Pour-Over Set", creator: "Kinto", url: null, status: "finished", rating: 4, reactions: ["beautiful"], genres: ["home"], metadata: { platform: ["wishlist"] }, content: "Bought this after staring at it for weeks. Looks good and is easy to clean.", coverImageRef: "coffee-window" },
  { id: "library-misc-2", type: "misc", title: "Pocket Field Recorder", creator: "Zoom", url: null, status: "in_progress", rating: null, reactions: ["interesting"], genres: ["audio"], metadata: { platform: ["gear"] }, content: "Still deciding whether this is practical or just appealing in theory.", coverImageRef: "shelf-detail" },
  { id: "library-misc-3", type: "misc", title: "Weekend Exhibition Notes", creator: null, url: null, status: "finished", rating: 4, reactions: ["thought-provoking"], genres: ["art"], metadata: { venue: "IMS Paulista" }, content: "Filing the exhibition under misc makes sense for now because it is mostly references and notes.", coverImageRef: "street-night" },
];
